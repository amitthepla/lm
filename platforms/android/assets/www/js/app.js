...
.run(function($cordovaPush,$rootScope,$ionicPlatform,$ionicPopup) {

  var androidConfig = {
    "senderID": "595169240862",
  };
      ...
      switch(notification.event) {
        case 'registered':
          if (notification.regid.length > 0 ) {
            window.localStorage["device_token"] = notification.regid;
            window.sessionStorage.setItem("DeviceTokenCookie", notification.regid);
          }
          break;
        ...
        console.log(notification);
		  ...
		  if(TeamNewsPostID != notification.news_item_id) {
